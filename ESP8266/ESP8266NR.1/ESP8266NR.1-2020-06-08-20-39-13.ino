  ...
  switch (D0_Zustand) {
    case 0:
      ...
      if (brightness_LED_ist_alt != brightness_LED_ist) {
        ...
        brightness_LEDG_ist = map(brightness_LED_ist, 0, 255, 0, 50);
        brightness_LEDB_ist = map(brightness_LED_ist, 0, 255, 0, 20);
    ...
    case 1:
      ...
      if (brightness_LED_ist_alt != brightness_LED_ist) {
        brightness_LEDR_ist = brightness_LED_ist;
        brightness_LEDG_ist = map(brightness_LED_ist, 0, 255, 0, 165);
        brightness_LEDB_ist = map(brightness_LED_ist, 0, 255, 0, 20);
