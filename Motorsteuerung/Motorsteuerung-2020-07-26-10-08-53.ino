...
void setup() {
  ...
  Timer3.initialize(100000);  //Motorsteuerung mit neuen Werten alle 100ms versorgen
...
//Strom auslesen
//  Mit Timer One im sicheren Abstand voneinader Gaspedal updaten ~75ms, wenn das klappt die anderen zeitabhängigen Funktionen entfernen
//ggf. Lüfter ansteuern
